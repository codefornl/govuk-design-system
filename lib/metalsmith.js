...
module.exports = metalsmith(__dirname) // __dirname defined by node.js: name of current working
  ...
  .use(concat({
    files: [
      'design-system/javascripts/vendor/jquery.min.js',
      'design-system/javascripts/vendor/clipboard.min.js',
      'design-system/javascripts/vendor/iframeResizer.min.js',
      'design-system/javascripts/components/example.js',
      'design-system/javascripts/components/tabs.js',
      'design-system/javascripts/components/copy.js',
      'design-system/javascripts/components/mobile-navigation.js',
      'design-system/javascripts/components/cookie-banner.js',
      'design-system/javascripts/main.js'
    ],
    output: 'design-system/javascripts/application.js'
  }))

  // concatenate IE only javascript files
  .use(concat({
    files: [
      'design-system/javascripts/vendor/html5shiv-printshiv.js',
      'design-system/javascripts/vendor/ie8.polyfils.min.js',
      'design-system/javascripts/ie-only.js'
    ],
    output: 'design-system/javascripts/ie.js'
  }))
  ...
  .use(rollup({
    input: 'src/design-system/javascripts/govuk-frontend.js',
    output: {
      legacy: true,
      format: 'iife',
      file: 'design-system/javascripts/govuk-frontend.js'
    },
    plugins: [
  ...
  .use(hashAssets({
    pattern: [
      'design-system/stylesheets/main.css',
      'design-system/stylesheets/main-ie8.css',
      'design-system/javascripts/application.js',
      'design-system/javascripts/ie.js',
      'design-system/javascripts/govuk-frontend.js',
      'design-system/javascripts/connection-status.js'
    ]
  }))
  ...
  .use(inplace({
    ...
    engineOptions: {
      ...
      globals: {
        ...
        // override asset path in GOV.UK Frontend's template.njk
        assetPath: '/design-system/assets'
      }
    }
  }))
